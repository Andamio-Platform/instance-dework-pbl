  ...
  return (
    <div>
      ...
      <h3 className="pb-3 text-xl text-secondary-content">Authors: {courseOutline.authors}</h3>
        <p className="font-medium text-base">Welcome to Dework PBL!</p>
        <p className="font-medium text-base">The purpose this course is to teach you how Governance Guild uses Dework to support collaboration and to reward contributors.</p>
